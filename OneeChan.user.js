    ...
    $SS =
    {
        ...
        options:
        {
            ...
            showTheme: function(tIndex)
            {
                ...
                "</select></label><label>" +
                "<span>Reply Opacity:</span><input type=text name=replyOp value='" + (bEdit ? tEdit.replyOp : "") + "'>" +
                "</label>";
        ...
        Themes:
        {
            ...
            [
                ...
                },
                {
                    ...
                    titleColor:  "bec2c4",
                    timeColor:   "93a1a1",
                    customCSS:   '.reply:not(.qphl){border-color:"+this.mainColor.hex+" !important}'
                },
                {
